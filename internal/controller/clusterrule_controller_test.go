...
var _ = Describe("ClusterRule Controller", func() {
	Context("When reconciling a resource", func() {
		...
		clusterrule := &auditv1alpha1.ClusterRule{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind ClusterRule")
			err := k8sClient.Get(ctx, typeNamespacedName, clusterrule)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ClusterRule")
