...
func reconcileCordoning(recorder events.EventRecorder, rule *auditv1alpha1.ClusterRule, node *corev1.Node, isCompliant bool) {
...
func reconcileLabeling(recorder events.EventRecorder, rule *auditv1alpha1.ClusterRule, node *corev1.Node, isCompliant bool) {
	nodeUpdated := false
